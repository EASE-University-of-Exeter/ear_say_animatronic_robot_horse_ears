...
#define PERCENTAGE_TIME_EARS_STATIC 10 // range 1-100% - % of time ears are static
...
#define PERCENTAGE_EAR_RANDOM_MICRO_MOVES_TENDING_TOWARDS_UPPER_LIMIT_OF_RANGE 80 // % of ear movements that tend towards upper limits of preset range 
